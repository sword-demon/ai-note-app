...
2. 添加一个新节点，输入`HTTP Request`，URL 选择上一步的`chatInput`，拖拽过去就行。
   ...
   ![image-20250914173130813](/image-20250914173130813.png)

3. 我们拿到的是一个`xml`内容，所以我们需要转换成`json`格式
4. ![image-20250914173241335](/image-20250914173241335.png)

5. 我们搜索一个`xml`节点，里面有可以将`xml`转换成`json`的选项配置
6. ![image-20250914173331404](/image-20250914173331404.png)
...
11. ![image-20250914174415001](/image-20250914174415001.png)

![image-20250914174432844](/image-20250914174432844.png)

还得打开下面的`Send Body`开关，消息体需要 2 个字段，一个是`urls`一个是`priority`

![image-20250914174636289](/image-20250914174636289.png)
...
![image-20250914175412579](/image-20250914175412579.png)
...
![image-20250914181313042](/image-20250914181313042.png)

最终我们添加一个`Convert to text file`节点，保存到本地文件内容中

![image-20250914181959822](/image-20250914181959822.png)

![image-20250914182127334](/image-20250914182127334.png)
...
![image-20250914185017313](/image-20250914185017313.png)
